...
const AboutAppSectionView = (props) => {
    ...
    return (
        <Flex flexDirection={"column"} flex={1} marginBottom={1}>
            <Box bg={"blue.500"} width={"100%"} paddingY={2} paddingX={6}>
                <Text
                    fontSize={"md"}
                    fontWeight={"semibold"}
                    color={"white"}
        ...
        return (
            <Link href={`${link}`} passHref target="_blank">
                <Button as="a" variant={"link"}>
                    <Text as={"u"} fontSize={"md"}>{`${text}`}</Text>
                </Button>
            </Link>
        );
    };
                ...
                <Flex flex={1} flexDirection={"column"} p={5}>
                    ...
                    <Flex flexDirection={"row"} mb={2}>
                        <Icon
                            ...
                            boxSize={"20px"}
                        />
                        <Box ms={2} alignContent={"center"}>
                            {renderLinkButtonControl(
                                "https://linkedin.com/in/iamrishigandhi",
                                "https://linkedin.com/in/iamrishigandhi"
                            )}
                        </Box>
                    </Flex>
            ...
            <>
                ...
                >
                    ...
                    <ModalContent overflow={"hidden"}>
                        ...
                        <ModalCloseButton />
                        <Divider />
                        <ModalBody m={0} p={0} bg={"chakra-body-bg"}>
